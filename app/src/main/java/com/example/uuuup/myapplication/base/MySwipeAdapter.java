...
public class MySwipeAdapter extends BaseSwipeAdapter implements View.OnClickListener {
    ...
    public MySwipeAdapter(Context context, List<String> list) {
...
//                Log.e(TAG, "onClick: ");
    ...
    public void fillValues(int position, View convertView) {
        TextView tvNickName = (TextView) convertView.findViewById(R.id.contact_name);
        ...
        tvNickName.setText(list.get(position));
    ...
    private ContactAdapter.OnItemLongClickListener onItemLongClickListener;

    public void setOnItemClickListener(ContactAdapter.OnItemClickListener listener){
        onItemClickListener= listener;
    }
    public void setOnItemLongClickListener(ContactAdapter.OnItemLongClickListener listener){
