...
import com.example.uuuup.myapplication.fragment.FragmentDriver;

import com.example.uuuup.myapplication.fragment.FragmentTwo;
import com.example.uuuup.myapplication.fragment.Fragmentfour;

public class LoginSuccessActivity extends TitleActivity implements BottomNavigationBar.OnTabSelectedListener  {
    private BottomNavigationBar mBottomNavigationBar;
    private FragmentDriver mFragmentOne;
...
//        mBottomNavigationBar.setBackgroundStyle(BottomNavigationBar.BACKGROUND_STYLE_RIPPLE);
        ...
        if (mFragmentOne == null) {
            mFragmentOne = FragmentDriver.newInstance();
        }
